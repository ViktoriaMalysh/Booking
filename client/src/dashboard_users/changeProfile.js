...
function ChangeProfile() {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(
      fetchChange(store.users.userId, name, surname, gender, age, country, phone, email, password));
    ...
    if (store.users.userRole === 1) history.push("/users/myProfile");
    else if (store.users.userRole === 2) history.push("/admin/Profile");
  };
  ...
  return (
    <div>
      {store.users.userRole < 2 ? (
        ...
        <div className="firstform7admin2">
          <div className="form117admin2">
            <Form>
              <Row className="mb-3">
                <Form.Group
                  className="mb-3"
